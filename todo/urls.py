...
urlpatterns = [
    ...
    path(
        ...
        include(
            [
                ...
                path("update/<int:task_id>/", views.update_task, name="tasks-update"),
                path("delete/<int:task_id>/", views.delete_task, name="tasks-delete"), 
            ]
        ),
        name="todo-tasks",
    ),
    path(
        ...
        include(
            [
                path(
                    "list/", views.TagViewSet.as_view({"get": "list"}), name="tags-list"
                ),
                path(
                    "create/",
